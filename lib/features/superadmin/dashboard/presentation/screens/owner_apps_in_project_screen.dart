            ...
            : _error != null
                ...
                : _apps.isEmpty
                    ? ListView(
                        ...
                        children: const [
                          SizedBox(height: 24),
                          Center(child: Text('No apps found for this owner')),
                        ],
                      )
                    : ListView.separated(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              title: Text(
                                a.appName.isEmpty ? '(Unnamed App)' : a.appName,
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                              ),
                              subtitle: Text('slug: ${a.slug}  •  ${a.status}'),
                              trailing: Row(
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) => OwnerAppOrdersScreen(
                                      ownerProjectId: a
                                          .id, // 🔹 this is the AUP id (ownerProjectId)
                                      appName:
                                          appTitle, // 🔹 optional: show on app bar
                                      // if your orders screen supports this, you can hint it’s super admin context:
